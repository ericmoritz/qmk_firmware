...
//|-------+-------+-------+-------+-------+-------|                    |-------+-------+-------+-------+-------+-------|
   KC_TILD,KC_EXLM,KC_AT  ,KC_HASH,KC_DLR ,KC_PERC,                     KC_CIRC,KC_AMPR,KC_ASTR,_______,KC_UNDR,KC_PLUS,
//|-------+-------+-------+-------+-------+-------|                    |-------+-------+-------+-------+-------+-------|
   KC_GRV ,KC_AMPR,KC_LBRC,KC_LCBR,KC_LPRN,KC_LT  ,                     KC_GT  ,KC_RPRN,KC_RCBR,KC_RLBC,KC_MINS,KC_EQL ,
//|-------+-------+-------+-------+-------+-------+-------.    .-------+-------+-------+-------+-------+-------+-------|
