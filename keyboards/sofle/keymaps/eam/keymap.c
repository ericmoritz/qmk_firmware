...
//|-------+-------+-------+-------+-------+-------|                    |-------+-------+-------+-------+-------+-------|
   _______,KC_BSLS,KC_ASTR,KC_MINS,KC_PLUS,_______,                     _______,_______,_______,_______,_______,_______,
//|-------+-------+-------+-------+-------+-------|                    |-------+-------+-------+-------+-------+-------|
   _______,KC_EQL ,_______,KC_LBRC,KC_LCBR,KC_LT  ,                     KC_GT  ,KC_RCBR,KC_RBRC,_______,KC_PIPE,_______,
//|-------+-------+-------+-------+-------+-------+-------.    .-------+-------+-------+-------+-------+-------+-------|
...
//|-------+-------+-------+-------+-------+-------|                    |-------+-------+-------+-------+-------+-------|
   _______,KC_BSLS,KC_ASTR,KC_MINS,KC_PLUS,_______,                     _______,_______,_______,KC_LBRC,KC_RBRC,KC_BSLS,
//|-------+-------+-------+-------+-------+-------|                    |-------+-------+-------+-------+-------+-------|
   _______,KC_EQL ,KC_LPRN,KC_LBRC,KC_LCBR,KC_LT  ,                     KC_LEFT,KC_DOWN, KC_UP ,KC_RGHT,_______,_______,
//`-------+-------+-------+-------+-------+-------+-------.    .-------+-------+-------+-------+-------+-------+-------|
   _______,_______,_______,KC_UNDS,_______,_______,_______,     _______,_______,_______,_______,_______,_______,_______,
//`-------+-------+-------+-------+-------+-------+-------|    |-------+-------+-------+-------+-------+-------+-------'
 ...
 */
  [_ADJUST] = LAYOUT(
//,-------+-------+-------+-------+-------+-------.                    ,-------+-------+-------+-------+-------+-------.
   XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,                     XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,KC_OSLK,
//|-------+-------+-------+-------+-------+-------|                    |-------+-------+-------+-------+-------+-------|
